					...
					<c:forEach var="persona" items="${personas}">
						<tr>
							...
							<td style="max-width:100px;">
								...
								<sf:form modelAttribute="personaDetalle" action="personas?detallarPersona" method="POST" style="display:inline-block;" class="formConsultarPersona">
									<sf:input type="hidden" value="0" name="accion" path="accion" />
									<sf:input type="hidden" path="idPersona" value="${personaDetalle.idPersona}"/>
									<input type="submit" value="Consultar" class="btn btn-primary" >
								</sf:form>
								
								<sf:form modelAttribute="personaDetalle" method="POST" style="display:inline-block;" class="formModificarPersona">
									<input type="hidden" value="modificar" name="accion">
									<sf:input type="hidden" path="idPersona" value="${personaDetalle.idPersona}"/>
									<input type="submit" value="Modificar" class="btn btn-success" >
								</sf:form>
								
								<sf:form modelAttribute="personaDetalle"  method="POST" style="display:inline-block;" class="formConsultarPersona">
